...
public class BetSmall extends SuperLocation{

    public BetSmall(Game g, UI userInterface, VisibilityManager vManager, Sound sndfft, Sound msc) {
        super(g, userInterface, vManager, sndfft, msc);
    }

    public static void betSmall(){
