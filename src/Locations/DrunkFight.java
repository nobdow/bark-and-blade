...
public class DrunkFight extends SuperLocation{

    public DrunkFight(Game g, UI userInterface, VisibilityManager vManager, Sound sndfft, Sound msc) {
        super(g, userInterface, vManager, sndfft, msc);
    }

    public static void drunkFight(){
